    ...
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f9fafb', padding: '40px 20px' }}>
      <div style={{ backgroundColor: '#fff', padding: '40px', borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          <h1 style={{ fontSize: '28px', fontFamily: 'var(--font-heading)', color: '#111827', margin: 0 }}>Créer un compte</h1>
          <p style={{ color: '#6b7280', marginTop: '10px', fontSize: '15px' }}>Rejoignez notre communauté de lecteurs.</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: '500', color: '#374151', fontSize: '14px' }}>Pseudo ou Prénom</label>
            <input 
              type="text" 
              name="name" 
              required 
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', marginBottom: '25px' }}>
            <input 
              type="checkbox" 
              id="cgu_accept"
            ...
            />
            <label htmlFor="cgu_accept" style={{ fontSize: '0.85rem', color: '#4b5563', cursor: 'pointer', lineHeight: '1.4' }}>
              J'accepte les <Link href="/cgu" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}>CGU</Link> et la <Link href="/politique-de-confidentialite" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}>Politique de Confidentialité</Link>.
            </label>
          </div>
